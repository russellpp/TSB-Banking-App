  ...
  return (
    <div className="adminDashboard">
      ...
      <div className="adminContent">
        {dashState.main && <ManageUsers accounts={accounts} setAccounts={setAccounts} />}
        {dashState.create && <CreateDash accounts={accounts} setAccounts={setAccounts} />}
        {dashState.deposit && <DepositDash accounts={accounts} setAccounts={setAccounts} />}
        {dashState.withdraw && <WithdrawDash accounts={accounts} setAccounts={setAccounts} />}
        {dashState.transfer && <TransferDash accounts={accounts} setAccounts={setAccounts} />}
      </div>
    </div>
  );
}
