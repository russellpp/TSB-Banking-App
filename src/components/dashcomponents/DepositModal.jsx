 ...
 */
function DepositModal({setIsDepositOpen, currentUser, setCurrentUser, accounts, setAccounts}) {
    ...
    <div className = "depositModal">
        <div className="depositModalContent">
            ...
            <div className="depositModalFooter">
                ...
                <button className="depositCancelButton" onClick={CloseDepositModal}>Cancel</button>
            </div>
        </div>  
    </div>
  )
